...
-   `Session Duartion`  - Que é significativamente diferente entre os clusters 1-2 e entre os clusters 1-3, não havendo evidência estatística para diferença entre os clusters 2-3.
...
-   `Workout Frequency`  - Que é significativamente diferente entre os clusters 1-2 e entre os clusters 1-3, não havendo evidência estatística para diferença entre os clusters 2-3.
